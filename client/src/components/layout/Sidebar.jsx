...
const Sidebar = ({ open, onClose }) => {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="hidden lg:block fixed top-0 left-0 w-64 h-full bg-gray-800 dark:bg-gray-900 text-white">
        <div className="p-4">
      ...
      {/* Mobile Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 w-64 bg-gray-800 dark:bg-gray-900 text-white z-50 transform transition-transform duration-300 ease-in-out lg:hidden ${
