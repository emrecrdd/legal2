...
const ClientDetail = () => {
  ...
  const message = encodeURIComponent(`Merhaba, ${client.first_name} ${client.last_name} ile iletişime geçmek istiyorum.`);
        ...
        <Card className="border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow">
          ...
          <Card.Body className="space-y-3">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <p className="text-xs uppercase tracking-wider text-gray-400 font-medium">TC Kimlik No</p>
                <p className="font-medium text-gray-900 dark:text-white">{client.tc_number || '-'}</p>
              </div>
              <div>
            ...
            <div>
              <p className="text-xs uppercase tracking-wider text-gray-400 font-medium">Şirket Adı</p>
